                    ...
                    <div class="p-8">
                        <div class="flex items-center mb-8">
                            <div class="h-12 w-12 rounded-full bg-indigo-100 flex items-center justify-center mr-4">
                                <span class="text-xl font-bold text-indigo-600">{{ substr(Auth::guard('user')->user()->name, 0, 1) }}</span>
                            </div>
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900">Welcome, {{ Auth::guard('user')->user()->name }}!</h2>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                            ...
                            @if($tasks->count() > 5)
                                <div class="p-6 border-t border-gray-100 bg-gray-50 rounded-b-xl">
                                    <a href="{{ route('intern.tasks') }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-medium">
                                        View all tasks
